...
def make_background_scheduler(job, interval_minutes: int, jitter_minutes: int = 0):
    """给 GUI 用的非阻塞调度器，需由调用方 start/shutdown。"""
    # daemon=True：避免 GUI 关闭后调度线程拖住进程不退出
